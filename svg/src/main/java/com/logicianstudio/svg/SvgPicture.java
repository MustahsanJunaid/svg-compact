...
public class SvgPicture {
     ...
     */
    SvgPicture(Picture picture, RectF bounds) {
        mPicture = picture;
        mBounds = bounds;
    }
     ...
     * @return the Drawable.
     */
    public SvgDrawable createDrawable(@Nullable View view, int sizeInPixels) {
        SvgDrawable drawable = getDrawable(view);
    ...
    public SvgDrawable getDrawable() {
        SvgDrawable drawable = new SvgDrawable(mPicture);
     ...
     */
    @Deprecated
    public SvgDrawable getDrawable(@Nullable View view) {
        SvgDrawable drawable = new SvgDrawable(view, mPicture);
        drawable.setBounds((int) mBounds.left, (int) mBounds.top, (int) Math.ceil(mBounds.right), (int) Math.ceil(mBounds.bottom));
        return drawable;
    }
